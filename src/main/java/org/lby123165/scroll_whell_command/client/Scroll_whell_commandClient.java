...
public class Scroll_whell_commandClient implements ClientModInitializer {
    ...
    // Edge-detect the open key to avoid flicker and repeats when key is held down
    ...
    private void onClientTick(MinecraftClient client) {
        ...
        // If any Screen is open (e.g., chat/inventory), do not open; if already open, cancel and close
